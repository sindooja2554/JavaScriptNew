...
class AddressBook 
{
    ...
    add() 
    {
        ...
        let zipCodeRegex:RegExp = /^[1-9][0-9]{5}$/;
        let contactRegex:RegExp = /^[0-9]{10}$/;
        console.log(this.data);

        let firstName:string = readline.question("Enter your First Name =");
        ...
        let lastName:string = readline.question("Enter your Last Name =");
        ...
        let address:string = readline.question("Enter Your Address =");
        ...
        let city:string = readline.question("Enter City Name =");
        ...
        let state:string = readline.question("Enter State Name =");
        ...
        let zipCode:string = readline.question("Enter Zip Code =");
        ...
        let mobileNo:string = readline.question("Enter Mobile Number =");
    ...
    updatePersonDetails() {
        ...
        var addressRegex:RegExp = /^[#.0-9a-zA-Z\s,-]+$/;
        var zipCodeRegex:RegExp = /^[1-9][0-9]{5}$/;
        var contactRegex:RegExp = /^[0-9]{10}$/;
        // let numberRegex :RegExp = /^[0-9]{1}$/;

        var mobileNo:string = readline.question("Enter Mobile Number =");
        ...
        if (this.isPresent(mobileNo)) {
            do {
                ...
                console.log("8.Exit");
                var choice: number = readline.questionInt("Enter Your Choice =");
     ...
     */
    displayParticularPersonDetails()
    {
        var contactRegex:RegExp = /^[0-9]{10}$/;
        var mobileNo:string = readline.question("Enter Mobile Number =");
        if(contactRegex.test(mobileNo)==false)
